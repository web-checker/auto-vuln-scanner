...
VERSION_META="$OS_NAME"    # 진단대상 시트 '버전정보' — WEB-25 가 Apache 버전을 잡으면 갱신
...
HISTORY="${OUTPUT_DIR}/web_diag_history_${LABEL}_${TS_FILE}.txt"
...
diag_web25() {
  ...
  VERSION_META="Apache ${ver}"   # 진단대상 시트 '버전정보'용(전역)
